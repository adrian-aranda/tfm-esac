...
if __name__ == '__main__':
    ...
    for obsid in obsid_list:
        ...
        try:
            ...
            plt.savefig('/home/aaranda/tfm/results_v2/{}/{}/theorical_psf_low.png'.format(target, obsid))
            plt.close(fig)
            ...
            ax.legend();
            plt.savefig('/home/aaranda/tfm/results_v2/{}/{}/radial_profile_low.png'.format(target, obsid))
            plt.close(fig)
        except:
