...
if __name__ == '__main__':
    ...
    for obsid in obsid_list:
        ...
        try:
            ...
            plt.savefig('/home/aaranda/tfm/results/{}/{}/smoothed_g2_image_high.png'.format(target, obsid))
            plt.close(fig)
            ...
            ax.set_xlabel('RA')
            ax.set_ylabel('DEC')
            plt.savefig('/home/aaranda/tfm/results/{}/{}/theorical_psf_high.png'.format(target, obsid))
            plt.close(fig)
            ...
            ax.legend()
            plt.savefig('/home/aaranda/tfm/results/{}/{}/radial_profile_high.png'.format(target, obsid))
            plt.close(fig)
        except:
